...
export default function MainCharts({ equityData, radarData, indiceScore, hasTrades }: any) {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          {equityData.length > 0 ? (
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={equityData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                ...
                <Tooltip contentStyle={{ backgroundColor: 'rgba(15, 23, 42, 0.9)', color: '#f8fafc', borderRadius: '12px', border: 'none', boxShadow: '0 4px 6px -1px rgb(0 0 0 / 0.1)' }} />
      ...
      {/* Módulo de Radar (reutilizando tu componente existente) */}
      <BunkerRadar 
        radarData={radarData} 
